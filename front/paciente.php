    ...
    <body>
		<div class="container">
			...
			<div class="btn-group"  id="root-buttons">
				<button id="ver-perfil" class="btn btn-default">Perfil</button>
				<button class="btn btn-default" id="agendar">Agendar</button>
				<button class="btn btn-default" id="minhas-consultas" onclick="ajaxPost('../server/verAgendaSimplificadaPaciente.php', '#result-historico')">Minhas Consultas</button>
