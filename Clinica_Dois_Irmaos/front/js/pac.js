...
$(document).ready(function(){
	...
	$("#ver-agenda").click(function(){
		$("#ver-agenda-div").collapse('toggle');
		$("#agendar-div").collapse('hide');
		$("#alterar-consulta-div").collapse('hide');
    });
    
    $("#Por-medico").click(function(){
		$("#Por-Medico-div").collapse('toggle');
		$("#Por-Especialidade-div").collapse('hide');
		
	});

	$("#Por-especialidade").click(function(){
		$("#Por-Medico-div").collapse('hide');
		$("#Por-Especialidade-div").collapse('toggle');
	});

	$("#Mostrar-historico").click(function(){
		$("#Mostrar-historico-div").collapse('toggle');
