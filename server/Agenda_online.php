...
<html>
	<head>
		...
		<?php 
			session_start();
			if((!isset ($_SESSION['id']) == true) and (!isset ($_SESSION['cpf']) == true) and (!isset ($_SESSION['senha']) == true)) {
				unset($_SESSION['id']);
				unset($_SESSION['cpf']);
	...
	<body>
		...
		<div class="container">
			...
			<div class="btn-group"  id="root-buttons">
				...
				<button class="btn btn-default" id="agenda">Agenda</button>
			</div>
				...
				<form name="form_cadastro" id="form_cadastro" onsubmit="return false;">
					<div class="border">
						...
						<div class="input-group">
							...
							<input id="name" class="form-control" type="text" name="name" placeholder="Nome" value="Cicera" required> 
			...
			<div class="collapse" id="agenda-div">
				<div class="border">
					...
					<div class="btn-group">
						...
						<button class="btn btn-default" id="ver-agenda">Ver agenda</button>
					</div>
					...
					<div class="collapse" id="alterar-consulta-div">
						...
						<div id="result-agendar-alterar">Ainda nao chamou</div>
					</div>

					<div class="collapse" id="ver-agenda-div">
						<h2>Ver agenda</h2>
						<form name="form_verAgenda" id="form_verAgenda" onsubmit="return false;">
							<!--Nome Médico-->
							<div class="input-group">
								<span class="input-group-addon"><i class="glyphicon glyphicon-plus-sign"></i></span>
							...
							<div class="submit-button" id="submit-agenda">
								<button type="submit" class="btn btn-default" id="btnVerAgenda" onclick="ajaxPost('../server/verAgendaSimplificada.php', '#result-verAgenda')">Buscar</button>
							</div>
						</form>
